...
export default async function BlogPage() {
  ...
  return (
    ...
    <div className="flex flex-col gap-3 mx-auto text-center">
      ...
      <h2>Se raser le crâne, cest tout un art. Je suis rasé depuis plus de 5 ans et je te partage mes meilleures astuces pour que ton crâne brille de mille feux.</h2>
